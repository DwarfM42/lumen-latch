...
- `tests/`: 既存7 test＋system energy 7 test
...
```
既存CSV基準SHA-256は `04dd5214e8900bd7ea660b4899feefbf9c448882b4bcaa7b9afd8fe4dc7fb1cf`。PNGは8枚。system CSVは3 scenario×80 operating points=240 data rows。
